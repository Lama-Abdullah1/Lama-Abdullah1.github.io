...
// Function to display and print the child's information
...
function handleFormSubmission(event) {
  ...
  if (validateFormInputs()) {
      ...
      // Store only the child's name in local storage
...
// Function to populate the 'Choose Kids' dropdown
...
function populateKidsDropdown() {
  ...
  for (var i = 0; i < localStorage.length; i++) {
    ...
    // Check if the key starts with 'child_'
